        ...
        <aside class="navbar navbar-vertical navbar-expand-lg" data-bs-theme="dark">
            <div class="container-fluid">
                ...
                <h1 class="navbar-brand navbar-brand-autodark">
                    <a href=".">
                        <img src="{{ asset('assets/images/logo.png') }}" alt="Las Musas" class="navbar-brand-image">
                    </a>
                </h1>
                ...
                <div class="collapse navbar-collapse" id="sidebar-menu">
                    <ul class="navbar-nav pt-lg-3">
                            ...
                            <div class="dropdown-menu">
                                <div class="dropdown-menu-columns">
                                    <div class="dropdown-menu-column">
                                        <a class="dropdown-item" href="{{ route('dashboard.indicadores') }}">
                                            Indicadores
                                        </a>
                                    </div>
                                    <div class="dropdown-menu-column">
                                        <a class="dropdown-item" href="{{ route('dashboard.rentabilidad') }}">
                                            Rentabilidad
                                        </a>
                                    </div>
                                    <div class="dropdown-menu-column">
                        ...
                        @if (auth()->user()->hasRole('admin') || auth()->user()->hasRole('credit_manager') || auth()->user()->hasRole('admin_credit'))
                            <li class="nav-item">
                        ...
                        @if (auth()->user()->hasRole('admin'))
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('interests.monthly') }}">
                                    <span class="nav-link-icon d-md-none d-lg-inline-block">
                                        <i class="ti ti-cash icon"></i>
                                    </span>
                                    <span class="nav-link-title">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('interests.sbs') }}">
                                    <span class="nav-link-icon d-md-none d-lg-inline-block">
